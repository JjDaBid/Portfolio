  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      ...
      .then(
        () => {
          setLoading(false);
          alert("Muchas gracias. Men contactaré contigo lo más pronto posible");
        ...
        (error) => {
          ...
          alert("Oops, Algo salió mal. Porfavor intente de nuevo.");
        }
      );
  };
        ...
        >
          ...
          <label className='flex flex-col'>
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder='Déjame tu mensaje por favor'
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
